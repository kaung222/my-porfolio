      ...
      <div className="px-5 md:px-[100px] mt-10">
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          >
            ...
            <p className="my-5 font-bold">Contact app with Laravel Api and Redux Toolkit</p>
            <div className="flex gap-2 items-center justify-between">
              <a
          ...
          >
            <img src={poster5} alt="" className="rounded" />
            <div className=" flex flex-wrap gap-1 mt-2">
              <span className=" bg-slate-600 text-white px-2 rounded-full text-sm">
                React
              </span>
            ...
            <p className="my-5 font-bold">
              BLog Website design by framer motion
            </p>
            <div className="flex gap-2 items-center justify-between">
              <a
                href="https://shimmering-smakager-95ab0b.netlify.app"
                className="text-primary hover:underline flex items-center gap-2"
              >
                <span>Preview</span>
                <span>
              ...
              <a
                href="https://github.com/kaung222/travel-blog"
                className="text-primary hover:underline flex items-center gap-2"
              >
                <span>View Repo</span>
                <span>
